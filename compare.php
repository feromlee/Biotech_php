                            ...
                            <div class="panel-body">
                                <form role="form" class="form-horizontal" action="" method="POST">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="col-sm-4 control-label">Day 1</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="col-sm-4 control-label">Day 2</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form_group col-md-1">
                                        <div class="col-sm-1">                                            
                                            <button type="submit" class="btn btn-blue">Compare</button>
                                        </div>
                                    </div>  
                                </form>
                            </div>
                            ...
                            <div class="tab-pane active" id="line-chart">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST["security_info"])) {
                                            $sql = "select distinct broker_name, broker_id from rawdata_" . $security_id . " where dday=" . $start_day . " or dday=" . $end_day . "  order by shareholding desc";
                                           //echo $sql;
                                            $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                // 输出数据
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $substr = "select shareholding,holding_percent from rawdata_" . $security_id . " where broker_id='" . $row["broker_id"] . "' and dday=" . $end_day;
                                                    //echo "<br>".$substr;
                                                    $result2 = $conn->query($substr);
                                                    if ($result2->num_rows > 0) {
                                                        $row2 = $result2->fetch_assoc();
                                                        $shareholding2 = $row2["shareholding"];
                                                        $holdingpercent2 = $row2["holding_percent"];
                                                    } else {
                                                        $shareholding2 = 0;
                                                        $holdingpercent2 = '0%';
                                                    }
                                                    
                                                    $shareholding = $shareholding2 - $shareholding1;                                                                                                        
                                                    
                                                    if ($shareholding > 0) {
                                                        $total_add=$total_add+$shareholding;
                                                    } else if ($shareholding < 0) {
                                                        $total_sub=$total_sub+$shareholding;
                                                    }

                                                

                                                    $holdingpercent=0;
                                                    $holdingpercent = trim($holdingpercent2,"%") - trim($holdingpercent1,"%");  
                                                    
                                                    echo "<tr>";
                                                    echo "<td>" . $row["broker_id"] . "</td>";
                                                    echo "<td>" . $row["broker_name"] . "</td>";
                                                    echo "<td>" . number_format($shareholding1) . "</td>";                                                    
                                                    echo "<td>" . number_format($shareholding2) . "</td>";
                                                    ...
                                                    echo "<td><b><font color='" . $color . "'>" . number_format($shareholding) . "</font></b></td>";
                                                    
                                                    echo "<td>" . $holdingpercent1 . "</td>";
                                                    echo "<td>" . $holdingpercent2 . "</td>";
                                                    
                                                    if ($holdingpercent > 0) {
                                                        $color = 'green';
                                                    } else if ($holdingpercent < 0) {
                                                        $color = 'red';
                                                    } else {
                                                        $color = '';
                                                    }
                                                    echo "<td><b><font color='" . $color . "'>" . round($holdingpercent,2) . " % </font></b></td>";
                                                    echo "</tr>";
                                                }
                                            }
                                        }
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>                                            
                                            <th><font color="green" size="4">总的增加量</font></th>                                            
                                            <th><font color="green" size="4">
                                                <?php
                                                                              
                                            echo number_format($total_add)."<br>";
                                        ...
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>                                            
                                            <th><font color="red" size="4">总的减少量</font></th>                                            
                                            <th> <font color="red" size="4">
                                                <?php
                                                                          
                                            echo number_format($total_sub)."<br>";
